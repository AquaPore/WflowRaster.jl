...
using ZipFile
   ...
   # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      function WFLOW_REMOVING_CLOUDS(;ΔLai_CloudTreshold, Path_SentinelMetadata₁, Dtm, Latitude, Longitude, Metadatas, NamePath_Fapar="FAPAR", NamePath_Fvc="FVC", NamePath_Lai="LAI", NamePath_Ndvi="NDVI", Path_SentinelBiophysical₁, Path_SentinelBiophysicalRemoveCloud, Subcatchment)
         ...
         # Dates between different satellite data
         ...
         copernicus.CORRECT_CLOUDS(;🎏_BiophysicalData=false, 🎏_Plots, CloudCover, DateSentinel, DaySentinel, Dtm, Latitude, Longitude, Metadatas, MonthSentinel, N, NameOutput_Lai₁, NamePath_Lai, Path_Lai, Path_SentinelBiophysicalRemoveCloud, Subcatchment, YearSentinel, ΔLai_CloudTreshold, Path_Ndvi, NamePath_Ndvi, NameOutput_Ndvi₁)

            # Path_Julia_Fapar = joinpath(Path_SentinelBiophysicalRemoveCloud, NamePath_Fapar, NameOutput_Lai₁[i] )
            # Path_Julia_Ndvi = joinpath(Path_SentinelBiophysicalRemoveCloud, NamePath_Fapar, NameOutput_Lai₁[i] )
            # Path_Julia_Fvc = joinpath(Path_SentinelBiophysicalRemoveCloud, NamePath_Fvc, NameOutput_Lai₁[i] )
            # println(Path_Julia_Lai)
      ...
      # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      function CORRECT_CLOUDS(;🎏_BiophysicalData=false, 🎏_Plots, CloudCover, DateSentinel, DaySentinel, Dtm, Latitude, Longitude, Metadatas, MonthSentinel, N, NameOutput_Lai₁, NamePath_Lai, Path_Lai, Path_SentinelBiophysicalRemoveCloud, Subcatchment, YearSentinel, ΔLai_CloudTreshold, Path_Ndvi, NamePath_Ndvi, NameOutput_Ndvi₁)
         ...
         # Initializing
            ...
            Lai_Uncorrected, LaiCloudTrue_Uncorrected = copernicus.DISCRZETZATION(;Dtm, iCount=2, Latitude, Longitude, Metadatas, Path=Path_Lai[2], Subcatchment)

            if 🎏_BiophysicalData
               Ndvi_1, NdviCloudTrue_1 = copernicus.DISCRZETZATION(;Dtm, iCount=1, Latitude, Longitude, Metadatas, Path=Path_Ndvi[1], Subcatchment)

               Ndvi_2, NdviCloudTrue_2 = copernicus.DISCRZETZATION(;Dtm, iCount=2, Latitude, Longitude, Metadatas, Path=Path_Ndvi[2], Subcatchment)
            end
         ...
         for i = 2:11-1
            ...
            if 🎏_BiophysicalData
               Ndvi_3, NdviCloudTrue_3 = copernicus.DISCRZETZATION(;Dtm, iCount=i+1, Latitude, Longitude, Metadatas, Path=Path_Ndvi[i+1], Subcatchment)
            end
            ...
            if 🎏_Plots
               ...
               geoPlot.HEATMAP(;🎏_Colorbar=true, Input=Lai_2, Title="LAI CORRECTED Year=$(YearSentinel[i]) Month=$(MonthSentinel[i]), Day=$(DaySentinel[i]), Cloud=$(CloudCover[i])", Label="Lai", colormap=:avocado, ColorReverse=true, Categorical=false)
            end # if 🎏_Plots
            ...
            # Perfornming the cycle
               ...
               if 🎏_BiophysicalData
                  ...
                  NdviCloudTrue_1 = deepcopy(NdviCloudTrue_2)
                  NdviCloudTrue_2 = deepcopy(NdviCloudTrue_3)
               end

         end # for iiSentinelData ∈ AllSentinelData
      end  # function: CORRECT_CLOUDS
      # ------------------------------------------------------------------
      ...
      # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
         function DISCRZETZATION(;Dtm, iCount, Latitude, Longitude, Metadatas, Method=:average, Path, Subcatchment)
